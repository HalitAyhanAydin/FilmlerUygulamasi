    ...
    var body: some View {
            ...
            GeometryReader { geometry in
                ...
                ScrollView {
                    ...
                    .navigationTitle(kategori.kategorie_adi!)
                    .onAppear {
                        var liste = [Filmler]()
                        ...
                        let y1 = Yonetmenler(yonetmen_id: 1, yonetmen_adi: "Quentin Tarantino")
                        let y2 = Yonetmenler(yonetmen_id: 2, yonetmen_adi: "Christopher Nolan")
                        let y3 = Yonetmenler(yonetmen_id: 3, yonetmen_adi: "Nuri Bilge Ceylan")
                        let y4 = Yonetmenler(yonetmen_id: 4, yonetmen_adi: "Roman Polanski")
